...
namespace CRUD2 {
    ...
    public partial class PersonaDataSet : global::System.Data.DataSet {
        ...
        public partial class AlumnosDataTable : global::System.Data.TypedTableBase<AlumnosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public AlumnosRow AddAlumnosRow(string Nombre, string Apellido, int Edad, string Correo, string Sexo, string Carrera) {
...
namespace CRUD2.PersonaDataSetTableAdapters {
    ...
    public partial class AlumnosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Alumnos] WHERE (([id] = @Original_id) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_Apellido) AND ([Edad] = @Original_Edad) AND ([Correo] = @Original_Correo) AND ([Sexo] = @Original_Sexo) AND ([Carrera] = @Original_Carrera))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Alumnos] ([Nombre], [Apellido], [Edad], [Correo], [Sexo], [Car" +
                "rera]) VALUES (@Nombre, @Apellido, @Edad, @Correo, @Sexo, @Carrera);\r\nSELECT id," +
                " Nombre, Apellido, Edad, Correo, Sexo, Carrera FROM Alumnos WHERE (id = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Alumnos] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [Edad] = @Edad, [Correo] = @Correo, [Sexo] = @Sexo, [Carrera] = @Carrera WHERE (([id] = @Original_id) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_Apellido) AND ([Edad] = @Original_Edad) AND ([Correo] = @Original_Correo) AND ([Sexo] = @Original_Sexo) AND ([Carrera] = @Original_Carrera));
SELECT id, Nombre, Apellido, Edad, Correo, Sexo, Carrera FROM Alumnos WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD2.Properties.Settings.Default.PersonaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Nombre, Apellido, Edad, Correo, Sexo, Carrera FROM dbo.Alumnos";
        ...
        public virtual int Fill(PersonaDataSet.AlumnosDataTable dataTable) {
        ...
        public virtual PersonaDataSet.AlumnosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PersonaDataSet.AlumnosDataTable dataTable = new PersonaDataSet.AlumnosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PersonaDataSet.AlumnosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_Nombre, string Original_Apellido, int Original_Edad, string Original_Correo, string Original_Sexo, string Original_Carrera) {
        ...
        public virtual int Insert(string Nombre, string Apellido, int Edad, string Correo, string Sexo, string Carrera) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Apellido, int Edad, string Correo, string Sexo, string Carrera, int Original_id, string Original_Nombre, string Original_Apellido, int Original_Edad, string Original_Correo, string Original_Sexo, string Original_Carrera, int id) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
            ...
            if ((Original_Carrera == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_Carrera));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, int Edad, string Correo, string Sexo, string Carrera, int Original_id, string Original_Nombre, string Original_Apellido, int Original_Edad, string Original_Correo, string Original_Sexo, string Original_Carrera) {
            return this.Update(Nombre, Apellido, Edad, Correo, Sexo, Carrera, Original_id, Original_Nombre, Original_Apellido, Original_Edad, Original_Correo, Original_Sexo, Original_Carrera, Original_id);
        }
    }
